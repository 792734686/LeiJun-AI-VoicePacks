function [B,JCB] = geom_ssiQS4( ENC,xi,eta,t )
...
B1 = [NDSHPG(1,1),0,0,0,h*NDSHPG(1,1),LDSHPG(1,1);
      0,NDSHPG(2,1),0,-h*NDSHPG(2,1),0,MDSHPG(2,1);
      NDSHPG(2,1),NDSHPG(1,1),0,-h*NDSHPG(1,1),h*NDSHPG(2,1),LDSHPG(2,1)+MDSHPG(1,1);
      0,0,NDSHPG(1,1),-LDSHPG(1,1),SHP(1)-MDSHPG(1,1),0;
      0,0,NDSHPG(2,1),-(LDSHPG(2,1)+SHP(1)),-MDSHPG(2,1),0];
B2 = [NDSHPG(1,2),0,0,0,h*NDSHPG(1,2),LDSHPG(1,2);
      0,NDSHPG(2,2),0,-h*NDSHPG(2,2),0,MDSHPG(2,2);
      NDSHPG(2,2),NDSHPG(1,2),0,-h*NDSHPG(1,2),h*NDSHPG(2,2),LDSHPG(2,2)+MDSHPG(1,2);
      0,0,NDSHPG(1,2),-LDSHPG(1,2),SHP(2)-MDSHPG(1,2),0;
      0,0,NDSHPG(2,2),-(LDSHPG(2,2)+SHP(2)),-MDSHPG(2,2),0];
B3 = [NDSHPG(1,3),0,0,0,h*NDSHPG(1,3),LDSHPG(1,3);
      0,NDSHPG(2,3),0,-h*NDSHPG(2,3),0,MDSHPG(2,3);
      NDSHPG(2,3),NDSHPG(1,3),0,-h*NDSHPG(1,3),h*NDSHPG(2,3),LDSHPG(2,3)+MDSHPG(1,3);
      0,0,NDSHPG(1,3),-LDSHPG(1,3),SHP(3)-MDSHPG(1,3),0;
      0,0,NDSHPG(2,3),-(LDSHPG(2,3)+SHP(3)),-MDSHPG(2,3),0];
B4 = [NDSHPG(1,4),0,0,0,h*NDSHPG(1,4),LDSHPG(1,4);
      0,NDSHPG(2,4),0,-h*NDSHPG(2,4),0,MDSHPG(2,4);
      NDSHPG(2,4),NDSHPG(1,4),0,-h*NDSHPG(1,4),h*NDSHPG(2,4),LDSHPG(2,4)+MDSHPG(1,4);
