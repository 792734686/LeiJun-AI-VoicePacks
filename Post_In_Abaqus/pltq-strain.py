...
strain_top=[]
# 得到最后一帧的结果数据，也可以是其他帧
lastFrame = step.frames[200]
# 获取应变场
strain_field = lastFrame.fieldOutputs['LE']
for item in range(a):
    ...
    region = odb.rootAssembly.instances['PART-1-1'].elementSets['SET-3']
    # 遍历所有实例和相应的单元
        # 获取该实例中单元集合的应变数据
